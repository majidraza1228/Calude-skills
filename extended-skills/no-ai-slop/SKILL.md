...
Cut throat-clearing and generic setup. Start with what the reader needs.

### Keep the user's meaning

Don't invent claims, examples, stats, or opinions. If something is unclear, ask.

### Use active voice with a human subject

"The team shipped it Tuesday" beats "the decision emerged." Never let inanimate things do human verbs.

### Be specific

Replace vague declaratives ("the implications are significant") with the actual implication. Names, numbers, and dates beat abstractions.

### Preserve useful edge

If the draft has a strong opinion, sharpen it. Don't sand it down to sound balanced.

### Keep structure unless it's hurting the piece

If you reorganize, say why in the What changed section.
